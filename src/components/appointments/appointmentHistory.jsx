...
function AppointmentHistory() {
    ...
    const citasGrupo = appointmentsData.slice(inicioCita, inicioCita + citasPorGrupo);
    ...
    return (
        <div className="flex justify-center items-center text-center">
            <div className="p-4" style={{ marginBottom: '100px' }}>
                ...
                <h1 className="text-2xl font-bold mb-10 text-orange-500">Historial de citas</h1>
                        ...
                        {citasGrupo.map((appointment) => (
                            ...
                            >
                                ...
                                <p className="text-lg font-semibold">{appointment.data}</p>
                                    ...
                                    <p className="text-gray-600">Payment: {appointment.payment}</p>
                                    <button className="bg-zinc-900 border border-orange-500 hover.bg-zinc-950 text-white px-2 py-1 rounded-md">Editar Cita</button>
                                </div>
